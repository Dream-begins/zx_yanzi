...
$result=mysql_query("select *,from_unixtime(TIME,'%Y-%m-%d %H:%i:%S') as datetime from db_zxshop $sql LIMIT $first,$pageSize");
    $total=mysql_num_rows(mysql_query("select * from db_zxshop $sql"));
$json='';
