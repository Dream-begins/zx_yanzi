    ...
    <div>
        <table class="tab_search">
            <tr>
               ...
               <td><input type="button" value="导出" onclick="exportData('currency','c_log_currency.php')" /></td>
            </tr>
        </table>
    </div>
...
$(function(){
    ...
    $('#currency #dataTable').datagrid({
        ...
        columns:[[
               ...
               {field:'TYPE',title:'货币类型',width:100},            
               {field:'CHARGEMOUNT',title:'充值金额',width:100},
               {field:'REDUCEDevote',title:'消耗帮贡',width:100},
               {field:'REDUCECopper',title:'消耗银币',width:80},
               {field:'REDUCEYuanBao',title:'消耗元宝',width:80},
               {field:'ADDMount',title:'当前货币增加量',width:100},
               {field:'NOWMount',title:'当前货币现存量',width:100},
