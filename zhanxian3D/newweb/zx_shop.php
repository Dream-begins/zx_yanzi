<?php #session_start();if(strpos(@$_SESSION['priv'],'newweb/zx_shop')==0)exit;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div>
        <table class="tab_search">
            <tr>
                ...
                <td><input type="button" value="导出" onclick="exportData('shop','../excle_shop.php')" /></td>
            </tr>
        </table>
    </div>
