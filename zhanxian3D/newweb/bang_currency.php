    ...
    <div>
        <table class="tab_search">
            <tr>
               ...
               <td><input type="button" value="导出" onclick="exportData('currency','c_bang_currency.php')" /></td>
...
$(function(){
    ...
    $('#currency #dataTable').datagrid({
        ...
        columns:[[
               ...
               {field:'REDUCEDevote',title:'消耗帮贡',width:80},
               {field:'ADDMount',title:'帮贡增加量',width:100},
               {field:'NOWMount',title:'帮贡现存量',width:100},
