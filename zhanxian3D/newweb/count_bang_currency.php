...
<script type="text/javascript">
    ...
    obj = {
        ...
        columns:[[
                {field:'sum1',title:'时间段内总消耗帮贡量',align:'center',width:200,height:50,formatter: 
                function(value,row,index){
                            return '<span style="font-size:20px">'+value+'</span>';//改变表格中内容字体的大小
                }},
                {field:'sum2',title:'时间段内总产出帮贡量',align:'center',width:200,height:50,formatter: 
                function(value,row,index){
                            return '<span style="font-size:20px">'+value+'</span>';//改变表格中内容字体的大小
                }},
                {field:'sum',title:'时间段内帮贡总剩余量',align:'center',width:200,height:50,formatter: 
                function(value,row,index){
                            return '<span style="font-size:20px">'+value+'</span>';//改变表格中内容字体的大小
                }},
        ...
        columns:[[
                ...
                {field:'count1',title:'消耗帮贡',width:100},
                {field:'count2',title:'帮贡增加量',width:100},
                {field:'count3',title:'帮贡现存量',width:100},
        ]],
    });
 });
