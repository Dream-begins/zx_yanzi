    ...
    <div>
        <table class="tab_search">
            <tr>
               ...
               <td><input type="button" value="导出" onclick="exportData('currency','c_yin_currency.php')" /></td>
...
$(function(){
    ...
    $('#currency #dataTable').datagrid({
        ...
        columns:[[
               ...
               {field:'ADDMount',title:'银币增加量',width:100},
               {field:'NOWMount',title:'银币现存量',width:100},
