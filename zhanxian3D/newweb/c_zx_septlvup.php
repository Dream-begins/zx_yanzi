...
$result=mysql_query("select *,from_unixtime(TIME,'%Y-%m-%d %H:%i:%S') as datetime from db_zxseptlvup $sql LIMIT $first,$pageSize");
    $total=mysql_num_rows(mysql_query("select * from db_zxseptlvup $sql"));
$json='';
