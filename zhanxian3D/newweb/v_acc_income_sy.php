...
<body style="padding:0px;margin:0px">
    ...
    <div id="toolbar">
        ...
        <a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="datagrid_load('c_acc_income_sy.php?action=list')">查询</a>
        <a href="#" class="easyui-linkbutton" iconCls="icon-search" onclick="putcsv('c_acc_income_sy.php?action=putcsv')">导出</a>
		</form>
    </div>
        ...
        function datagrid_load(url)
        {
            $('#dg').datagrid({
                ...
                columns:[[
                    ...
                    {field:'VIP',title:'VIP',width:300,halign:'center',align:'center'},
                    {field:'CTIME',title:'创建时间',width:300,halign:'center',align:'center'},
                    {field:'SUM_AMOUNT',title:'RMB(分)',width:150,halign:'center',align:'center',sortable:true},
                    {field:'SUM_YB',title:'元宝(元宝)',width:300,halign:'center',align:'center',sortable:true},
