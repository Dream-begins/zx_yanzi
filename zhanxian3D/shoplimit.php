...
='red'>第一行必填</font></td>
				...
				<tr>
					<td>基金道具ID:</td>
					<td><input required="true" style="width:150px" name="MONEYID" id="MONEYID"></td>
					<td>礼包信息:</td>
					<td><input required="true" style="width:150px" name="AWARDS" id="AWARDS"></td>
					<td>阶段价格:</td>
					<td><input required="true" style="width:150px" name="STAGEPRICES" id="STAGEPRICES"></td>
				</tr>

				<tr>
					<td>道具描述:</td>
					<td><input required="true" style="width:150px" name="DESC" id="DESC"></td>
					<td>是否显示预售:</td>
					<td><input required="true" type="checkbox"  name="PRESHOW" id="PRESHOW"></td>
					<td></td>
					<td></td>
				</tr>
				<tr>
...
function queryShopItem(whichzone)
{
	...
	$('#shoplimit #dataTable').datagrid({
		...
		onSelect:function onDataGridSelect(rowIndex, rowData)
		{
			...
			$("#shoplimitform #MONEYID").val(rowData["MONEYID"]);
			$("#shoplimitform #AWARDS").val(rowData["AWARDS"]);
			$("#shoplimitform #STAGEPRICES").val(rowData["STAGEPRICES"]);
			if(rowData["PRESHOW"]==1){
			 $("#shoplimitform #PRESHOW").prop("checked",true);
                        }else{
                         $("#shoplimitform #PRESHOW").prop("checked",false);
                        }
			$("#shoplimitform #DESC").val(rowData["DESC"]);
		},
		columns:[[
			...
			{field:'WEIGHT',title:'道具品质',width:60,sortable:true},
