...
$pg     = intval($spg)-1;
$sql    = "SELECT from_unixtime(TIME,'%Y-%m-%d %H:%i:%S') as datetime,SERVERID,ZONEID,USERID,ACCNAME,NAME,LEVEL,PARA1,PARA2,PARA3,PARA4,PARA5,EXTRA,FABAOEVENT,FABAOID,FABAONAME,COST,ITEMID,ITEMCOUNT,ITEMNAME from db_zxfabao order by datetime desc";
...
if($export)
{
    ...
    export(array("时间","服务器id","区域id","玩家id","账号名","玩家名","玩家等级","参数1","参数2","参数3","参数4","参数5","额外信息","事件","任务id","法宝名称","消耗银币","消耗道具id","消耗道具数量","消耗道具名称"),$rows,"斩仙法宝");
}    
