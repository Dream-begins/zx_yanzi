...
$pg     = intval($spg)-1;
$sql    = "SELECT from_unixtime(TIME,'%Y-%m-%d %H:%i:%S') as datetime,SERVERID,ZONEID,USERID,ACCNAME,NAME,LEVEL,PARA1,PARA2,PARA3,PARA4,PARA5,EXTRA,SEPTNAME,SHOPTYPE,GOODSID,ITEMID,ITEMCOUNT,ITEMNAME,CURTYPE,ALLPRICE from db_zxshop order by datetime desc";
...
if($export)
{
    ...
    export(array("时间","服务器id","区域id","玩家id","账号名","玩家名","玩家等级","参数1","参数2","参数3","参数4","参数5","额外信息","仙踪名","商店类型","商品id","物品id","物品数量","物品名","货币类型","总价"),$rows,"斩仙商店");
}    
