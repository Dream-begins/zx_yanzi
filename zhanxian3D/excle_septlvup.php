...
$pg     = intval($spg)-1;
$sql    = "SELECT from_unixtime(TIME,'%Y-%m-%d %H:%i:%S') as datetime,SERVERID,ZONEID,USERID,ACCNAME,NAME,LEVEL,PARA1,PARA2,PARA3,PARA4,PARA5,EXTRA,SEPTID,SEPTNAME,BUILDTYPE,BUILDLEVEL,COSTTYPE,COST from db_zxseptlvup order by datetime desc";
...
if($export)
{
    ...
    export(array("时间","服务器id","区域id","玩家id","账号名","玩家名","玩家等级","参数1","参数2","参数3","参数4","参数5","额外信息","仙踪id","仙踪名称","建筑类型","建筑等级","消耗货币类型","消耗量"),$rows,"斩仙仙宗升级");
}    
