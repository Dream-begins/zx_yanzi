<?php 
    session_start();
    if(strpos(@$_SESSION['priv'],'newweb/v_serversummary')==0)exit;
    include_once 'getlan.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<script type="text/javascript">
    ...
    {
        $("#serversummary #dataTable").html("<?php echo MANAGER_607; ?> ...");
        $("#serversummary #dataTable").load("c_serversummary.php?lan=<?php echo $_SESSION['lan']; ?>",$("#summaryfrm").serialize());
    }
